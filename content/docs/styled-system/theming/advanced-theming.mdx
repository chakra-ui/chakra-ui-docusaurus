...
:::note
If you're using TypeScript, you'll want to include some documentation
guiding consumers of your theme package to add a `postinstall` script to
generate typings for your theme. See the
[theme typings](/docs/styled-system/theming/advanced-theming#theme-typings) section
for details.
:::
...
or, for a
[theme package](/docs/styled-system/theming/advanced-theming#distributing-a-theme-package):
...
:::caution
If you delete the `node_modules` directory, you'll need to re-run the
