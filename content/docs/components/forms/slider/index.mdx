...
The `Slider` component wraps all its children in the [Box](/docs/components/layout/box)
...
`SliderThumb` composes [Box](/docs/components/layout/box) so you can pass all `Box` props
to change its style.

### SliderFilledTrack Props

`SliderFilledTrack` composes [Box](/docs/components/layout/box) so you can pass all `Box`
props to change its style.

### SliderTrack Props

`SliderTrack` composes [Box](/docs/components/layout/box) so you can pass all `Box` props
to change its style.
