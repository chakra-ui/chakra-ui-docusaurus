...
:::tip
Still using v0 and want to upgrade to v1? [Go here](https://v1.chakra-ui.com/guides/migration)
:::
...
Discord chat here: [discord.gg/chakra-ui](https://discord.gg/chakra-ui).
:::
