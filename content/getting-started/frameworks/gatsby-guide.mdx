...
```tsx title="src/@chakra-ui/gatsby-plugin/theme.js"
...
If you want to use the [default theme](/docs/styled-system/theming/default-theme)
there's no need to shadow the file.
