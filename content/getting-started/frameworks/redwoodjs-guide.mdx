...
If you intend to
[customize the default theme](/docs/styled-system/customize-theme), you
...
[Storybook integration Guide](/integrations/with-storybook), only the
...
2. Add the addon to your configuration in `web/config/storybook.config.js`:
   ...
   ```tsx title="web/config/storybook.config.js"
   module.exports = {
     addons: [
       // ...
...
3. Additional configuration:
   ...
   ```tsx title="web/config/storybook.preview.js"
